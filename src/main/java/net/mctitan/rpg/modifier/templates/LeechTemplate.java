...
public class LeechTemplate extends ModifierTemplate {
    private DamageType damagetype;
    private double precision;
    private double flat;
    private int steps;

    public LeechTemplate(int rank, boolean base, boolean monster, String id, DamageType damagetype,
    ...
    public LeechTemplate(PersistentDataContainer pdc) {
        super(pdc);
    ...
    public LeechTemplate(ConfigurationSection section) {
        super(section);
    ...
    public Modifier modifier(Random random) {
        ...
        return new LeechModifier(rank(), this, base(), monster(), damagetype(), value);
    }
    ...
    public String string() {
        ...
        return String.format("%s%% %s Life Leech", valuestr, damagetype().string());
    }
