...
public class DurationConfig extends ModifierConfig {
    public DurationConfig(String id) { super(id); }
    public DurationConfig(String id, ConfigurationSection section) { super(id, section); }
    ...
    public ModifierTemplate template(int rank) {
        return new DurationTemplate(rank, base(), monster(), id(), operator(),
