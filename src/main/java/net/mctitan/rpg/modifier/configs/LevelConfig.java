...
public class LevelConfig extends ModifierConfig {
    public LevelConfig(String id) { super(id); }
    public LevelConfig(String id, ConfigurationSection section) { super(id, section); }
    ...
    public ModifierTemplate template(int rank) {
        return new LevelTemplate(rank, base(), monster(), id(), operator(),
