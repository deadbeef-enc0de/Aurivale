...
public class DefenseConfig extends ModifierConfig {
    public DefenseConfig(String id) {
        super(id);
    }
    public DefenseConfig(String id, ConfigurationSection section) { super(id, section); }
    ...
    @Override
    public Class<? extends Modifier> modifierclass() { return DefenseModifier.class; }

    @Override
    public ModifierTemplate template(int rank) {
        return new DefenseTemplate(rank, base(), monster(), id(), damagetype(), operator(),
