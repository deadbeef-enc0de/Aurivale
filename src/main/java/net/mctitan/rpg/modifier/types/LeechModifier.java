...
public class LeechModifier extends Modifier {
    private DamageType damagetype;
    private double value;

    public LeechModifier() {} // for YamlSaver

    public LeechModifier(int rank, ModifierTemplate template, boolean base, boolean monster,
    ...
    public LeechModifier(PersistentDataContainer pdc) {
        super(pdc, new LeechTemplate(pdc.get(Key.TEMPLATE_KEY, PersistentDataType.TAG_CONTAINER)));
    ...
    public Component text() {
        ...
        return Component.text(String.format("%s%% %s Life Leech", valuestr, damagetype().string()));
    }
